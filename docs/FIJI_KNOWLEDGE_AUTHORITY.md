...
| Tours | Partner Directory / product owner | approved operator product record | before display and monthly | Public + partner confidential | Public fields | Yes / booking-time | owner, terms, versions |
...
| Activities | Partner Directory / product owner | approved provider records | monthly and booking-time | Public changing | Public fields | Yes / availability live | product/version/access logs |
| Cruise excursions | Partner Directory / cruise product owner | operator, port and ship schedule | per sailing and change | Public changing | Public fields | Always / Yes | sailing/source/decision logs |
...
| Deals | Promotion authority / commercial owner | approved campaign and funding record | effective window; automatic expiry | Public + confidential rules | Published terms only | Yes / Always | approval, budget, redemption audit |
...
| Operational notices | relevant operational authority / incident owner | official/operator event | immediate, expire explicitly | Public/Internal real-time | If approved/public | Always / Always | issuer, scope, expiry, access |
