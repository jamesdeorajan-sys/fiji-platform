...
**`marketplace.vakaviti.ai`** as the canonical public hostname for Stage 1, **conditional on CEO
confirmation that this does not conflict with the Lagi product's use of the root domain and its
subdomains.** This choice:
