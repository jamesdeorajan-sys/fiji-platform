...
3. **Authority:** identity, consent, knowledge, destination, availability, interim/future fare, promotion, quote, booking, partner, lead, dispatch, payment, communication, currency-rate, operational-notice, audit-evidence, profile, and review services.
